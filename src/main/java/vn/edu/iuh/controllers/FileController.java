...
import vn.edu.iuh.dto.UploadFileResponseDTO;
...
public class FileController {
    ...
    public String saveFile(@RequestBody UploadFileRequestDTO uploadFileRequestDTO, @AuthenticationPrincipal UserPrincipal userPrincipal) {
